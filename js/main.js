...
sr.reveal('.galary__content>.content__item:nth-of-type(odd)', { duration: 2500, origin: 'right', distance: '100px' });
...
sr.reveal('.footer .info .nets', { duration: 3000, origin: 'right', distance: '100px'});
